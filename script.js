  ...
  home: {
    ...
    results: [
      ...
      },
      {
        max: 16,
        title: "這個空間可能正在消耗你",
        copy: "這個分數代表家裡的狀態很可能長期在消耗你，而且已經影響到休息與關係。建議先做一次完整檢測，把優先處理的位置找出來，再決定要不要進一步支持。",
      },
    ],
  },
  business: {
    ...
    results: [
      ...
      },
      {
        max: 10,
        title: "你的現場已經有明顯卡點",
        copy: "這幾個訊號同時出現，代表卡住的可能不是產品或行銷，而是現場本身。先做一次檢測，看清楚是哪個位置在讓客人離開、讓團隊消耗。",
      },
      {
        max: 16,
        title: "這個現場可能正在消耗你的生意",
        copy: "這個分數代表現場很可能每天都在流失客人與消耗團隊。建議盡快做一次完整檢測，把優先處理的位置找出來，再決定調整的順序。",
      },
    ],
  },
  office: {
    ...
    results: [
      ...
      },
      {
        max: 10,
        title: "你的辦公空間已經有明顯卡點",
        copy: "這幾個訊號同時出現，代表卡住的可能不是人或制度，而是空間本身。先做一次檢測，看清楚是哪個位置在影響專注與協作。",
      },
      {
        max: 16,
        title: "這個空間可能正在消耗你的團隊",
        copy: "這個分數代表辦公空間很可能每天都在消耗團隊的專注與動能。建議先做一次完整檢測，把優先處理的位置找出來，再決定調整順序。",
      },
    ],
  },
};
